(function (global, factory) {
	...
	(factory((global.ldd3 = global.ldd3 || {})));
...
var BottomCategoricalAxis = (function () {
    ...
    function BottomCategoricalAxis(container, _width, _height) {
        ...
        this._scale = band()
            .range([0, _width]);
        this._axis = axisBottom(this._scale);
    }
    /**
...
var LeftCategoricalAxis = (function () {
    function LeftCategoricalAxis(container, _width, _height) {
        ...
        this._scale = band()
            .range([0, _height]);
        this._axis = axisLeft(this._scale);
    }
...
var LeftLinearAxis = (function () {
    ...
    LeftLinearAxis.prototype.format = function (specifier) {
        this._axis.tickFormat(format(specifier));
        return this;
    };
...
var HorizontalBarChart = (function () {
    function HorizontalBarChart(containerId, _width, _height) {
        ...
        this._title = new title(select(selector).select('svg'), this._width, this._height);
...
var LinearLinearChart = (function () {
    ...
    LinearLinearChart.prototype.update = function (data, xDomain, yDomain) {
        var _this = this;
        if (!xDomain) {
            xDomain = extent(data, function (d) { return _this._x(d); });
        }
        if (!yDomain) {
            yDomain = extent(data, function (d) { return _this._y(d); });
        }
...
var CategoricalLinearChart = (function () {
    function CategoricalLinearChart(selector, _width, _height) {
        ...
        var width = _width;
        var height = _height;
        var svg = select(selector) //casting to any is required to be able to call select without error
            .append('svg')
            .attr('width', width)
            .attr('height', height);
        this._group = svg;
        ...
        this._legend = new Legend(legendContainer, this._width, this._plotHeight)
            ...
            .color(function (d, i) { return category10[i]; });
    }
    ...
    CategoricalLinearChart.prototype.update = function (data) {
        ...
        this._yAxis.domain([0, max(data, function (d, i) { return _this._y(d, i); })]);
        var grouped = nest()
        ...
        enterSelection.append('path')
            ...
            .style('stroke', function (d, i) { return category10[i]; });
...
var TimeLinearChart = (function () {
    ...
    TimeLinearChart.prototype.update = function (data) {
        var _this = this;
        this._timeAxis.domain(extent(data, function (d, i) { return _this._x(d, i); }));
        this._leftAxis.domain([0, max(data, function (d, i) { return _this._y(d, i); })]);
...
var MultiCategoricalChart = (function () {
    ...
    MultiCategoricalChart.prototype.update = function (data) {
        ...
        this._yAxis.domain(extent(data, this._y));
        var bandWidth = this._xAxis.bandWidth();
        var secondaryScale = band()
